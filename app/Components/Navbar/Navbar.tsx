...
export default function Navbar() {
  ...
  return (
    <>
      {/* NAVBAR */}
      <nav className={`fixed w-full z-30 transition-all duration-500 ${
        scrolled ? 'bg-black/90 navbar-blur' : 'bg-transparent'
      }`}>
      ...
      {/* Menu Fullscreen */}
      <div
        className={`fixed inset-0 w-full h-full z-50 transition-all duration-500 ${
      ...
      >
        ...
        <div className={`grid md:grid-cols-[35%_65%] grid-cols-1 h-full ${
